...
namespace Prowl.PaperUI
{
    ...
    public class StyleTemplate : StyleSetterBase<StyleTemplate>
    {
        ...
        private GuiProperties _guiProperties = new();
        ...
        public override StyleTemplate SetStyleProperty<T>(GuiProp property, T value)
        {
            ...
            StyleUtils.SetValueInStruct(property, ref _guiProperties, value);
        ...
        public void ApplyTo(ElementHandle element)
        {
            ...
            foreach (var property in _setStyleProps)
            {
    ...
    public class ElementBuilder : StyleSetterBase<ElementBuilder>, IDisposable
    {
        ...
        {
            var fontSize = (double)_handle.Data._elementStyle.GetValue<double>(GuiProp.FontSize);
            var letterSpacing = (double)_handle.Data._elementStyle.GetValue<double>(GuiProp.LetterSpacing);
            ...
            int intID)
        {
            ...
            OnPostLayout((ElementHandle elHandle, Rect rect) =>
            {
                _paper.AddActionElement(ref elHandle, (canvas, r) =>
                {
                    ...
                    var fontSize = (double)elHandle.Data._elementStyle.GetValue<double>(GuiProp.FontSize);
