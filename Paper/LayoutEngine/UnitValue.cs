...
namespace Prowl.PaperUI.LayoutEngine
{
    ...
    public struct UnitValue
    {
        ...
        public bool HasLerp => _lerpData != null;

        public static int NumberOfCreations = 0;
        public static int NumLastFrame = 0;
        public static UnitValue DefaultAuto = new(Units.Auto);
        public static UnitValue DefaultStretch = new(Units.Stretch);
        public static UnitValue DefaultMinPx = new(Units.Pixels, 0);
        public static UnitValue DefaultMaxPx = new(Units.Pixels, double.MaxValue);

        public static void ResetCount()
        {
            NumLastFrame = NumberOfCreations;
            NumberOfCreations = 0;
        }
